    ...
    public class CustomerActivityServiceTests : ServiceTest
    {
        ...
        public new void SetUp()
        {
           ...
           _customer2 = new Customer
           {
            ...
            _customerActivityService = new CustomerActivityService(new Mock<IEventPublisher>().Object, _activityLogRepository.Object, _activityLogTypeRepository.Object, new TestCacheManager(), _webHelper.Object, _workContext.Object);
        }
